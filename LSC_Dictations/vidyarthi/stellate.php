...
<center>
<h1>Stellate Ganglion Block</h1>
<br>
<form method=post action=stellatedictation.php>
<table>
<tr>
...
-->
<br>
<button type=submit name=location class="box effect1 effect7" value="leftCRPS">left CRPS</button><br>
<button type=submit name=location class="box effect1 effect7" value="leftperiph">left PN</button><br>
<button type=submit name=location class="box effect1 effect7" value="rightCRPS">right CRPS</button><br>
<button type=submit name=location class="box effect1 effect7" value="rightperiph">right PN</button><br>
</form>
<br>

...
<tr>
<td><b>Pre-Operative Diagnosis:<br><br><br></b></td><td>1. Muscle spasm<br>2. Myofascial pain syndrome<br><br></td>
</tr>
<tr>
<td><b>Post-Operative Diagnosis:</b><br><br><br></td><td>1. Muscle spasm<br>2. Myofascial pain syndrome<br><br></td>
</tr>
<tr>
...
$l=$_POST["location"];
echo ucfirst($l);
?> piriformis muscle injection<br><br></td>
</tr>
<tr>
...
<tr>
<td colspan=2>A pleasant patient presents with muscle spasm and myofascial pain causing significant pain and morbidity. 
<?php
$history=$_POST["history"];
echo $history;
?>
 The patient is undergoing a diagnostic and potentially therapeutic piriformis muscle spasms having failed more conservative measures.<br><br></td>
</tr>
<tr>
...
?> piriformis muscle. With negative aspirations, needle tip location was confirmed with Omnipaque 240mg/mL, less than 0.5mL was used. Then, after negative aspiration, 1mL of a solution containing 0.5mL of 40mg/mL of triamcinolone and 0.5mL of 0.25% bupivacaine was incrementally injected. The needle was withdrawn intact. The patient's skin was then cleaned.
<?php
if ($l=="bilateral")
{

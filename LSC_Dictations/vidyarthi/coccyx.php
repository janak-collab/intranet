...
<center>
<h1>Sacrococcygeal/Intercoccygeal Joint Injection</h1>
<br>
<form method=post action=coccyxdictation.php>
<table>
<tr>
...
<!--
<table>
<tr><td>Referring:</td><td><tr><td>Referring:</td><td>
   <SELECT NAME=ref>
      <OPTION VALUE=0>
<?php
...
-->
<br>
<button type=submit name=location class="box effect1 effect7" value="1">1 joint</button><br>
<button type=submit name=location class="box effect1 effect7" value="2">2 joints</button><br>
<button type=submit name=location class="box effect1 effect7" value="3">3 joints</button><br>
</form>
<br>

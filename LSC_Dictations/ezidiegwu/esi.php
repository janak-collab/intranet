...
<h1>Epidurals</h1>
<br>
<form method=post action=esidictation.php>
<table>
<tr>
...
-->
<br><br><br>
<button type=submit name=location1 value="C7-T1" class="box effect1 effect7">C7-T1</button><br><br>
TESI:<br>
<select class="box effect7 effect1" name=location2 onChange="this.form.submit();">
  ...
  <option value="T7-8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;T7-8</option>
  <option value="T8-9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;T8-9</option>
  <option value="T9-10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;T9-10</option>
  <option value="T10-11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;T10-11</option>
  <option value="T11-12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;T11-12</option>
  <option value="T12-L1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;T12-L1</option>
</select>
<br><br>
<button type=submit name=location3 value="L1-2" class="box effect1 effect7">L1-2</button><br><br>
<button type=submit name=location3 value="L2-3" class="box effect1 effect7">L2-3</button><br><br>
<button type=submit name=location3 value="L3-4" class="box effect1 effect7">L3-4</button><br><br>
<button type=submit name=location3 value="L4-5" class="box effect1 effect7">L4-5</button><br><br>
<button type=submit name=location3 value="L5-S1" class="box effect1 effect7">L5-S1</button><br><br>
<button type=submit name=location3 value="Caudal" class="box effect1 effect7">Caudal</button><br><br><br>
</form>

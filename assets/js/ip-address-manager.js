...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add IP button click event - with debugging
    console.log('Looking for Add IP button...');
    const addBtn = document.querySelector('#addIPBtn');
    console.log('Add button found:', addBtn);
    console.log('Button already has listener?', addBtn ? addBtn.__listenerAttached : 'no button');
    ...
    if (addBtn) {
        ...
        // Now add a single listener to the fresh button
        newAddBtn.addEventListener('click', function(e) {
            e.preventDefault();
            e.stopPropagation();
            console.log('Add button clicked ONCE');
            addIP();
            return false;
        });
        
        console.log('Event listener attached to fresh button');
    }
